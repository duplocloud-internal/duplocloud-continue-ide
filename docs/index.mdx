...
icon: book-open
description: "Kick off agents from the terminal, IDE, or Mission Control"
---
...
<Note>
  **Launch background agents, iterate in terminal, and deploy workflows in CI/CD**
</Note>
...
<CardGroup cols={2}>
  <Card
    title="VS Code"
    icon="code"
    href="https://marketplace.visualstudio.com/items?itemName=DuploCloud.continue"
  >
